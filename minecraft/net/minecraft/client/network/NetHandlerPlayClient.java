...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    {
    	{
    		EventPacketType eventPacketPost = new EventPacketType(PacketDir.OUT, EventType.PRE, p_147297_1_, null);
    		eventPacketPost.hook(eventPacketPost);
    	}
    	{
            EventPacket eventPacket = new EventPacket(PacketDir.OUT, p_147297_1_, null);
            eventPacket.hook(eventPacket);
    	...
    	{
    		EventPacketType eventPacketPost = new EventPacketType(PacketDir.OUT, EventType.POST, p_147297_1_, null);
    		eventPacketPost.hook(eventPacketPost);
    	}
    }
