...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void clickMouse()
    {
        ...
        if (this.leftClickCounter <= 0)
        {
            ...
            else
            {
                ...
                {
                    case ENTITY:
                    	EventHitEntity eventHit = new EventHitEntity(this.objectMouseOver.entityHit);
                    	eventHit.hook(eventHit);
    ...
    public void runTick() throws IOException
    {
        ...
        EventScaffold eventScaffold = new EventScaffold(true);
        
        if(Minecraft.getMinecraft().theWorld != null) {
	        eventTick.hook(eventTick);
	    	eventScaffold.hook(eventScaffold);
        }
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    {
                    	InputKeyEvent inputKeyEvent = new InputKeyEvent(k);
                    	inputKeyEvent.hook(inputKeyEvent);
            ...
            else
            {
                while (this.gameSettings.keyBindAttack.isPressed())
                {
                	...
                	InputClickEvent eventClick = new InputClickEvent();
                	eventClick.hook(eventClick);
