...
import axyl.client.modules.features.other.Blink;
...
public class PlayerControllerMP
{
    ...
    public boolean onPlayerRightClick(EntityPlayerSP player, WorldClient worldIn, ItemStack heldStack, BlockPos hitPos, EnumFacing side, Vec3 hitVec)
    {
        ...
        else
        {
            ...
            if(Axyl.ins.modManager.getModuleByName("Blink").isToggled()) {
            	Blink.packets.add(new C08PacketPlayerBlockPlacement(hitPos, side.getIndex(), player.inventory.getCurrentItem(), f, f1, f2));
            } else {
