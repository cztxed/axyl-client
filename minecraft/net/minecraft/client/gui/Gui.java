...
public class Gui
{
    ...
    public static void drawGradientRectSideways(double x, double height, double y, double width, int startingColor, int endingColor) {
        float f = (float)(startingColor >> 24 & 0xFF) / 255.0F;
        float f1 = (float)(startingColor >> 16 & 0xFF) / 255.0F;
        float f2 = (float)(startingColor >> 8 & 0xFF) / 255.0F;
        float f3 = (float)(startingColor & 0xFF) / 255.0F;
        float f4 = (float)(endingColor >> 24 & 0xFF) / 255.0F;
        float f5 = (float)(endingColor >> 16 & 0xFF) / 255.0F;
        float f6 = (float)(endingColor >> 8 & 0xFF) / 255.0F;
        float f7 = (float)(endingColor & 0xFF) / 255.0F;
        GL11.glEnable(3042);
        GL11.glDisable(3553);
        ...
        GL11.glVertex2d(x, width);
        GL11.glColor4f(f5, f6, f7, f4);
        GL11.glVertex2d(y, width);
        GL11.glVertex2d(y, height);
        GL11.glEnd();
        GL11.glPopMatrix();
        GL11.glEnable(3553);
        GL11.glDisable(3042);
