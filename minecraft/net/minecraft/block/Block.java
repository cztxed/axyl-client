...
public class Block
{
    ...
    public void addCollisionBoxesToList(World worldIn, BlockPos pos, IBlockState state, AxisAlignedBB mask, List<AxisAlignedBB> list, Entity collidingEntity) {
    	...
    	EventBoundingBox eventBlockBoundingBox = new EventBoundingBox(axisalignedbb, worldIn.getBlockState(pos).getBlock(), pos);
    	eventBlockBoundingBox.hook(eventBlockBoundingBox);
    	
    	if(eventBlockBoundingBox.isCancelled())
    		return;
