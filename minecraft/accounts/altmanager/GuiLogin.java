...
public class GuiLogin extends GuiScreen {
    ...
    public void drawScreen(final int x2, final int y2, final float z2) {
        ...
        Fonts.tahoma_bold.drawCenteredString("Username", (int)(this.width / 2), (int)(sr.getScaledHeight() / 2 - 65), new Color(49, 49, 69, 250).getRGB());
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(1, this.width / 2 - 50 - 10, this.height / 2+1, 120, 20, "Go back"));
